...
"\
\\001\000\001\000\027\000\006\000\016\000\007\000\015\000\008\000\014\000\
\\009\000\013\000\010\000\012\000\000\000\
\\001\000\002\000\010\000\003\000\009\000\011\000\008\000\012\000\007\000\
\\013\000\006\000\000\000\
\\001\000\004\000\026\000\006\000\016\000\007\000\015\000\008\000\014\000\
\\009\000\013\000\010\000\012\000\000\000\
\\001\000\005\000\029\000\006\000\016\000\007\000\015\000\008\000\014\000\
\\009\000\013\000\010\000\012\000\000\000\
...
\\033\000\000\000\
\\034\000\000\000\
\\035\000\002\000\010\000\003\000\009\000\011\000\008\000\012\000\007\000\
\\013\000\006\000\000\000\
\\036\000\006\000\016\000\007\000\015\000\008\000\014\000\009\000\013\000\
\\010\000\012\000\000\000\
\\037\000\006\000\016\000\007\000\015\000\008\000\014\000\009\000\013\000\
\\010\000\012\000\000\000\
\\038\000\000\000\
\\039\000\000\000\
\\040\000\000\000\
...
\\018\000\019\000\001\000\001\000\
\\001\000\009\000\001\000\001\000\
\\001\000\001\000\001\000\016\000\
\\002\000\000\000\008\000\013\000\
\\012\000\014\000\015\000\011\000\
\\001\000\017\000\003\000\001\000\
\\010\000\005\000"
val gotoT =
"\
...
val terms : term list = nil
 $$ (T 14) $$ (T 13) $$ (T 10) $$ (T 9) $$ (T 8) $$ (T 7) $$ (T 6) $$ 
...
formula1 = formula1 ()
 ...
 in (
PT.statementToString( (PT.fts(formula1,statement1)) :PT.mystatement ); PT.fts(formula1,statement1) 
)
end)
...
formula1 ()
 val  formula2 = formula2 ()
 in (PT.withbinop(formula1,PT.myimplies,formula2) )
end)
...
formula1 ()
 val  formula2 = formula2 ()
 in (PT.withbinop(formula1,PT.myand,formula2) )
end)
 in ( LrTable.NT 3, ( result, formula1left, formula2right), rest671)
...
formula1 ()
 val  formula2 = formula2 ()
 in (PT.withbinop(formula1,PT.myor,formula2) )
end)
 in ( LrTable.NT 3, ( result, formula1left, formula2right), rest671)
...
formula1 ()
 val  formula2 = formula2 ()
 in ( PT.withbinop(formula1,PT.myxor,formula2))
end)
 in ( LrTable.NT 3, ( result, formula1left, formula2right), rest671)
...
formula1 ()
 val  formula2 = formula2 ()
 in ( PT.withbinop(formula1,PT.myequals,formula2))
end)
 in ( LrTable.NT 3, ( result, formula1left, formula2right), rest671)
...
fun CONST (i,p1,p2) = Token.TOKEN (ParserData.LrTable.T 12,(
